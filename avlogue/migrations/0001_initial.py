# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-15 20:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_bitrate', models.PositiveIntegerField(blank=True, null=True, verbose_name='audio bitrate')),
                ('audio_channels', models.PositiveIntegerField(blank=True, null=True, verbose_name='audio channels')),
                ('video_codec', models.CharField(choices=[(b'h264', b'h264'), (b'mpeg4', b'mpeg4'), (b'vp8', b'vp8'), (b'theora', b'theora')], max_length=20, verbose_name='video codec')),
