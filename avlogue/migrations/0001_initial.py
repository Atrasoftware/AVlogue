# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-21 21:05
from __future__ import unicode_literals

import avlogue.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_codec', models.CharField(choices=[(b'pcm_f32le', b'pcm_f32le'), (b'pcm_s16be', b'pcm_s16be'), (b'aac', b'aac'), (b'vorbis', b'vorbis'), (b'ac3', b'ac3'), (b'mp3', b'mp3')], max_length=20, null=True, verbose_name='audio codec')),
                ...
                ('bitrate', models.PositiveIntegerField(blank=True, null=True, verbose_name='average file bitrate')),
                ...
                ('file', models.FileField(upload_to=b'avlogue/audio', validators=[avlogue.utils.ContentTypeValidator((b'audio/.*',), message='Only audio files are allowed.')], verbose_name='audio file')),
            ],
            options={
                'abstract': False,
            },
            bases=(avlogue.models.FileChangedMixin, models.Model),
        ),
        migrations.CreateModel(
            name='AudioFormat',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='name')),
                ('formats', models.ManyToManyField(related_name='format_sets', to='avlogue.AudioFormat', verbose_name='audio formats')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conversion_task_id', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='Conversion task id')),
                ('status', models.IntegerField(choices=[(0, 'Preparation to conversion'), (1, 'In progress'), (2, 'Success'), (3, 'Failure')], default=0, verbose_name='conversion status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('audio_bitrate', models.PositiveIntegerField(blank=True, null=True, verbose_name='audio bitrate')),
                ('audio_channels', models.PositiveIntegerField(blank=True, null=True, verbose_name='audio channels')),
                ('video_codec', models.CharField(choices=[(b'h264', b'h264'), (b'mpeg4', b'mpeg4'), (b'vp8', b'vp8'), (b'theora', b'theora')], max_length=20, null=True, verbose_name='video codec')),
                ...
                ('description', models.TextField(blank=True, verbose_name='description')),
                ('date_added', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date published')),
                ('file', models.FileField(upload_to=b'avlogue/video', validators=[avlogue.utils.ContentTypeValidator((b'video/.*',), message='Only video files are allowed.')], verbose_name='video file')),
                ('preview', models.FileField(blank=True, null=True, upload_to=b'avlogue/video', verbose_name='video preview')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_height', models.IntegerField(blank=True, null=True, verbose_name='video height')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='name')),
                ('container', models.CharField(choices=[(b'3gp', b'3gp'), (b'flv', b'flv'), (b'mkv', b'matroska'), (b'mp4', b'mp4'), (b'avi', b'avi'), (b'ogg', b'ogg'), (b'webm', b'webm')], max_length=10, verbose_name='container format')),
                ('audio_codec_params', models.CharField(blank=True, help_text='Raw options to configure a selected audio codec', max_length=400, verbose_name='audio codec params')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, unique=True, verbose_name='name')),
                ('formats', models.ManyToManyField(related_name='format_sets', to='avlogue.VideoFormat', verbose_name='formats')),
            ],
            options={
                'abstract': False,
            },
